...
class StokProdukController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'deskripsi' => 'nullable|string|max:255', // Validasi untuk deskripsi
        ]);
        ...
        // Record stock change in StokOpname table with description
        StokOpname::create([
            'id' => $nextId,
            ...
            'deskripsi' => $request->deskripsi // Menyimpan deskripsi ke database
        ]);
